...
public class Border {
	...
	private int year;
	public Border(int state1no, String state1ab, int state2no, String state2ab, int year) {
		super();
	...
	public String toString() {
		return "Border [state1no=" + state1no + ", state1ab=" + state1ab + ", state2no=" + state2no + ", state2ab="
				+ state2ab + ", year=" + year + "]";
	}
